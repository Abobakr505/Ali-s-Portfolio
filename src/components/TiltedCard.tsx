...
export default function TiltedCard({
  ...
  return (
    ...
    >
      ...
      <motion.div
        className="relative [transform-style:preserve-3d] w-[300px] h-[300px] md:w-[370px] md:h-[370px]"
        style={{
          rotateX,
          rotateY,
          scale
      ...
      >
        <motion.img
          src={imageSrc}
          alt={altText}
          className="absolute top-0 left-0 object-cover rounded-[15px] will-change-transform [transform:translateZ(0)] w-[300px] h-[300px] md:w-[470px] md:h-[470px]  "
        />
