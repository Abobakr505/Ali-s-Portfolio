  ...
  return (
    <>
      ...
      <footer className="main-container grid md:grid-cols-2 lg:grid-cols-4 gap-10 py-20">
        ...
        <div>
  <h5 className='font-medium mb-4 font-heading '>Quick Links</h5>
<ul className="flex flex-col gap-2 text-base lg:text-lg">
  {[
    ...
    <li key={item.path}>
      <Link
        to={item.path}
        className="group relative pl-4 inline-flex items-center gap-2 transition"
      >
        {/* Dot */}
        <span
          className="
            absolute left-0 w-2 h-2 rounded-full bg-white
            opacity-0 scale-0
        ...
        <div>
          <h5 className='font-medium mb-4 font-heading '>Services</h5>
          <ul className='flex flex-col gap-2 text-base lg:text-lg'>
            <li>3D Modeling</li>
        ...
        <div>
          <h5 className='font-medium mb-4 font-heading '>Contact</h5>
          <ul className='flex flex-col gap-2 text-base lg:text-lg'>
...
<div className='main-container grid md:grid-cols-2 gap-3 py-6 lg:py-8 max-md:text-center'>
  ...
  <div className='flex gap-3 justify-center md:justify-end'>
    {/* Social Icons */}
     <a href="https://wa.me/+201026635585" target="_blank">
            <IoLogoWhatsapp className='text-white w-7 h-7'/>
          </a>
    <a href="https://www.linkedin.com/in/ali-hassan-607932198/" target="_blank">
          ...
          <a href="https://www.instagram.com/alihasan5335?igshid=YTQwZjQ0NmI0OA%3D%3D" target="_blank">
            <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <a href="https://www.facebook.com/profile.php?id=100003329446201&mibextid=ZbWKwL" target="_blank">
            <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
