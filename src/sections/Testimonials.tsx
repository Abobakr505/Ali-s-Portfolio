...
const testimonials = [
  {
    ...
    role: "Business Owner",
    feedback:
      "Exceptional service! The design quality was outstanding and the communication was smooth. Highly recommended.",
  },
  {
    name: "Sarah Ali",
...
const Testimonials = () => {
  ...
  return (
    <section
      ref={containerRef}
      className="w-full bg-black text-white py-16 px-6 flex flex-col items-center"
    >
      <h2 className="text-center text-5xl md:text-6xl font-bold mb-10 tracking-tight">
        What Clients Say
      </h2>
      ...
      <div className="relative w-full max-w-3xl h-[340px] flex items-center justify-center overflow-hidden">
        {testimonials.map((t, i) => (
          <div
            ...
            className={`absolute w-full bg-white/5 border border-white/10 backdrop-blur-xl rounded-2xl p-10 shadow-2xl transition-all`}
          >
