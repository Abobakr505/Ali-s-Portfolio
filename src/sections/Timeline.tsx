...
const timelinedate = [
  ...
  { title: "Work EXPERIENCE ", plus:" - CG Artist" , desc: "I worked for a  LODESTAR - VISUAL Compny as a Full-Time CG Artist .", icon: BriefcaseBusiness, date: "2025 - 2026" },
    { title: "Work EXPERIENCE ", plus:" - CG Artist" , desc: "I am Working For a Vanilla Studio Compny as a Full-Time CG Artist .", icon: FiPenTool, date: "2026" },
